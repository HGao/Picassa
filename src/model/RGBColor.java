...
public class RGBColor implements Comparable<RGBColor>, Iterable<Double> {
    ...
    public static final int JAVA_COLOR_MAX = 255; // should be defined in
    // java.util.Color
    ...
    public RGBColor toGreyScale() {
        return new RGBColor(0.30 * getRed() + 0.59 * getGreen() + 0.11
                * getBlue());
    }
    ...
    public int compareTo(RGBColor other) {
        return Double.compare(toGreyScale().getRed(), other.toGreyScale()
                .getRed());
    }
